...
public class VigenereBreaker {
    ...
    public void breakVigenere (File encripted_filepath) {
        //WRITE YOUR CODE HERE
        FileResource fr = new FileResource(encripted_filepath);
        String encrypted = fr.asString();
        
        HashMap<String, HashSet<String>> map = new HashMap<String, HashSet<String>>();
        map.put("Danish", readDictionary("Danish", new FileResource("Array-list-data/data/dictionaries/Danish")));
        map.put("Dutch", readDictionary("Dutch", new FileResource("Array-list-data/data/dictionaries/Dutch")));
        map.put("English", readDictionary("English", new FileResource("Array-list-data/data/dictionaries/English")));
        map.put("French", readDictionary("French", new FileResource("Array-list-data/data/dictionaries/French")));
        map.put("German", readDictionary("German", new FileResource("Array-list-data/data/dictionaries/German")));
        map.put("Italian", readDictionary("Italian", new FileResource("Array-list-data/data/dictionaries/Italian")));
        map.put("Portuguese", readDictionary("Portuguese", new FileResource("Array-list-data/data/dictionaries/Portuguese")));
        map.put("Spanish", readDictionary("Spanish", new FileResource("Array-list-data/data/dictionaries/Spanish")));
